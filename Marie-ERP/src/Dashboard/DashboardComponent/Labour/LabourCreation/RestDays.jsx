...
function RestDays() {
  ...
  useEffect(() => {
    ...
    // console.log(formattedRestDays);
    // console.log(formattedUserDefinedDays)
    ...
    // console.log(formattedUserDefinedDays[0]?.split("-")[0]);
    // console.log(formattedUserDefinedDays[0]?.split("-")[1]);
    ...
    console.log("restDates : ", restDates);
    console.log("restDayCount :", restDayCount);
    ...
    <>
      <Container>
        ...
        <Row className="text-end mb-5">
          <Col>
            <Link to="/dashboard/labour/records/c">
              <button
