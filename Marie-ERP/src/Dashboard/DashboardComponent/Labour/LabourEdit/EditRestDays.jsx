...
function EditRestDays() {
  const { setRestDates, restDayCount, setRestDayCount, setMonth, setYear } =
    LabourContextHelper();
  const { empId, userDefineDays, setUserDefineDays, setuserDefinedStatus } =
  ...
  console.log("userDefindedDays : ", userDefineDays);
  return (
    <>
      <Container>
        <div>
        ...
        <Row className="text-end mb-5">
          <Col>
            <Link to={`/dashboard/labour/records/e/${empId}`}>
              <button
